...
SAP Master Data Integration core functionality is to provide replication capabilities for application that connect to the central master data database. However, SAP Master Data Integration is also supporting advanced master data processes with SAP Master Data Governance \(MDG\) on top.
