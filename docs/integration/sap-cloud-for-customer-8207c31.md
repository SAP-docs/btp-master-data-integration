...
Partner determination configurations must be downloaded from the back-office system and uploaded to SAP Master Data Integration - Business Partners to validate incoming master data via SOAP channel.
